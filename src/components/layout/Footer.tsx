    ...
    <footer className="bg-travel-blue text-white py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">GuideConnect</h3>
            <p className="text-gray-300 mb-4">
              Connecting travelers with certified local guides for authentic experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/safety" className="text-gray-300 hover:text-white transition">Safety Center</Link></li>
              <li><Link to="/community" className="text-gray-300 hover:text-white transition">Community Guidelines</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} GuideConnect. All rights reserved.
          </p>
